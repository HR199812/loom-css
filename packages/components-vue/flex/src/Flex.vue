...
.loom-flex--primary:hover:not(.loom-flex--disabled) {
...
.loom-flex--secondary:hover:not(.loom-flex--disabled) {
...
.loom-flex--outline:hover:not(.loom-flex--disabled) {
  background-color: #3b82f6;
  color: white;
}
...
.loom-flex--danger:hover:not(.loom-flex--disabled) {
