...
.loom-form--primary:hover:not(.loom-form--disabled) {
...
.loom-form--secondary:hover:not(.loom-form--disabled) {
...
.loom-form--outline:hover:not(.loom-form--disabled) {
  background-color: #3b82f6;
  color: white;
}
...
.loom-form--danger:hover:not(.loom-form--disabled) {
