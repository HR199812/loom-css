...
.loom-list--primary:hover:not(.loom-list--disabled) {
...
.loom-list--secondary:hover:not(.loom-list--disabled) {
...
.loom-list--outline:hover:not(.loom-list--disabled) {
  background-color: #3b82f6;
  color: white;
}
...
.loom-list--danger:hover:not(.loom-list--disabled) {
