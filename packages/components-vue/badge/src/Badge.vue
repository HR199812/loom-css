...
.loom-badge--primary:hover:not(.loom-badge--disabled) {
  background-color: #2563eb;
}

.loom-badge--secondary {
  background-color: #6b7280;
  color: white;
}

.loom-badge--secondary:hover:not(.loom-badge--disabled) {
...
.loom-badge--outline:hover:not(.loom-badge--disabled) {
  background-color: #3b82f6;
  color: white;
}
...
.loom-badge--danger:hover:not(.loom-badge--disabled) {
